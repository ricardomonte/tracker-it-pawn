...
const url = 'https://tracker-tracker-api-fp.herokuapp.com/api/v1/playhours';
...
export const loadPlayHourDog = (id) => (dispatch) => {
  ...
  axios.get(`https://tracker-tracker-api-fp.herokuapp.com/api/v1/dogs/${params.dog_id}/my_hours`, { headers: { Authorization: `Bearer ${auth}` } }).then((response) => {
